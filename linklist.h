...
class LinkedList
{
	private:
		...
		ListNode<T>* get_node_by_index(int index) const;
	public:
		LinkedList() {};
		...
		bool is_empty() const;
		ListNode<T>* get_first_ptr() const;
		ListNode<T>* get_last_ptr() const;
		T get_first() const;
		T get_last() const;
...
template <class T> 
LinkedList<T>::LinkedList(LinkedList<T> &list) : length(list.length)
{
...
template <class T>
ListNode<T>* LinkedList<T>::get_first_ptr() const
{
	return first_ptr;
}
...
template <class T>
ListNode<T>* LinkedList<T>::get_last_ptr() const
{
	return last_ptr;
}
